...
const createProject = async ({
  ...
  try {
    ...
    const ethCost = ethers.utils.parseEther(cost);
...
const structuredProjects = (projects) =>
  projects
    .map((project) => ({
      ...
      // умножаем на 1000 для корректной конверсии времени
      timestamp: new Date(project.timestamp.toNumber() * 1000).getTime(),
      expiresAt: new Date(project.expiresAt.toNumber() * 1000).getTime(),
...
const reportError = (error) => {
  ...
  // Можно добавить дополнительную обработку ошибки тут
};
